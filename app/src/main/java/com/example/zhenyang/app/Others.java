...
public class Others extends Activity {
    ...
    public void onAddItem1(View v) {
        EditText etNewItem = (EditText) findViewById(R.id.etItem1);
        EditText etNewPrice = (EditText) findViewById(R.id.etPrice1);
    ...
    private void readItems(){
        ...
        File todoFile = new File(filesDir, "other.txt");
        try {
    ...
    public void onBackPressed(){
        ...
        Intent otherint = new Intent();
        String otherstring = String.valueOf(sumFood(newcost));
        //Toast.makeText(this, "otherstring " + otherstring, Toast.LENGTH_LONG).show();

        otherint.putExtra("other", otherstring);
        setResult(Activity.RESULT_OK, otherint);
        finish();


    }

    private static final String SHARED_PREFS_NAME = "MY_SHARED_PREFS1";
