...
public class Transport extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvItems = (ListView) findViewById(R.id.lvItems3);
    ...
    public void onAddItem3(View v) {
        EditText etNewItem = (EditText) findViewById(R.id.etItem3);
        EditText etNewPrice = (EditText) findViewById(R.id.etPrice3);
    ...
    private void readItems(){
        ...
        File todoFile = new File(filesDir, "transports.txt");
        try {
    ...
    public void onBackPressed(){
        ...
        Intent transportint = new Intent();
        String transportstring = String.valueOf(sumFood(newcost));
        //Toast.makeText(this, "transportstring " + transportstring, Toast.LENGTH_LONG).show();

        transportint.putExtra("transport", transportstring);
        setResult(Activity.RESULT_OK, transportint);
        finish();


    }

    private static final String SHARED_PREFS_NAME = "MY_SHARED_PREFS3";
